    ...
    const renderItem = ({ item }) => {
        return (
            <View>
                ...
                <View>
                    <Carousel />
                    <View style={{flexDirection:'row',alignItems:'center',gap:10, paddingHorizontal:8,borderColor:"#0c8708",borderWidth:2,paddingVertical:10,borderRadius:10, margin:20}}>
