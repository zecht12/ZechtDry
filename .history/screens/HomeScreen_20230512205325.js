                ...
                <ScrollView>
                    ...
                    <View>
                        <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center', gap:10, paddingHorizontal:10}}>
                            <View style={{flexDirection:'row',alignItems:'center',gap:10, paddingHorizontal:8,borderColor:"#0c8708",borderWidth:2, width:"85%",paddingVertical:10,borderRadius:10, marginVertical:15, marginHorizontal:6}}>
