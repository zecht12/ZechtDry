            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <View style={{ marginTop: 80, paddingHorizontal: 3, width: '100%', height: '100%', alignItems: 'center', justifyContent:'center' }}>
                    ...
                    <View style={{ width: '100%', height: '100%', paddingHorizontal: 12, marginTop: 16, }}>
                        <View>
                            <Input placeholder='Email' autoFocus={true} keyboardType='email-address' value={email} onChangeText={(text) => setEmail(text)} errorStyle={{ color: 'red' }} errorMessage='Please enter the correct email' />
