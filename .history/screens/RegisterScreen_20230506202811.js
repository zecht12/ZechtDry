            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <View style={{ marginTop: 56, paddingHorizontal: 3, width: '100%', height: '100%', alignItems: 'center' }}>
                    ...
                    <View style={{ width: '100%', height: '100%', paddingHorizontal: 12, marginTop: 4 }}>
                        ...
                        <Input placeholder='Password' leftIcon={<MaterialCommunityIcons name="phone" size={20} />} secureTextEntry={true} type="password" value={password} onChangeText={(text) => setPassword(text)} />
