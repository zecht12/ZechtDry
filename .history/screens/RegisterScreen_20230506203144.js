            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <View style={{ marginTop: 56, paddingHorizontal: 3, width: '100%', height: '100%', alignItems: 'center' }}>
                    ...
                    <View style={{ width: '100%', height: '100%', paddingHorizontal: 12, marginTop: 4 }}>
                        <Input placeholder="Full Name" leftIcon={<MaterialCommunityIcons name="account" size={20} />} autoFocus={true} type="text" value={name} onChangeText={(text) => setName(text)}errorStyle={{ color: 'red' }} errorMessage='Please fill out the s' />
