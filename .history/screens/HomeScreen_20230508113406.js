    ...
    const renderItem = ({ item }) => {
        return (
            <ScrollView>
                ...
                <View>
                    <View style={{flexDirection:'row',alignItems:'center',gap:10, paddingHorizontal:8,borderColor:"#0c8708",borderWidth:2,paddingVertical:10,borderRadius:10, marginVertical:, marginHorizontal:10}}>
