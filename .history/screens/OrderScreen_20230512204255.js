...
const OrderScreen = () => {
    ...
    return (
        <SafeAreaView>
            <LottieView source={require("../assets/thumbs.json")} style={{ height: 300, width: 300, alignSelf: "center", justifyContent: "center" }} autoPlay loop={false} speed={0.7} />
            <Text style={{ fontSize: 19, fontWeight: "600", textAlign: "center" }}>Your order has been placed</Text>
            ...
            <LottieView source={require("../assets/sparkle.json")} style={{ position: "absolute", alignSelf: "center" }} autoPlay loop={false} speed={0.7} />
        </SafeAreaView>
    );
};
