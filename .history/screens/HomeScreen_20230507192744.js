    ...
    const renderItem = ({ item }) => {
        return (
            <View>
                ...
                <View>
                <Pressable onPress={() => navigation.navigate("Search")} style={{flexDirection:'row',alignItems:'center',gap:10, paddingHorizontal:8,borderColor:"#ffc72c",borderWidth:2,paddingVertical:10,borderRadius:10,}}>
