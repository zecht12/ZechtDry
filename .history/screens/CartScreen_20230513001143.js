...
const CartScreen = () => {
    ...
    const total = cart
        ...
        const placeOrder = async () => {
            navigation.navigate("Order", { pickUpDetails: route.params ? route.params : {}, orders: route.params ? route.params : {} });
            dispatch(cleanCart());
            await setDoc(
    ...
    return (
        <>
            ...
            {total === 0 ? null : (
                ...
                <Pressable onPress={placeOrder} style={{borderColor: "#fff", borderWidth:2, paddingHorizontal:8, paddingVertical:2, borderRadius:6,}}>
                    <Text style={{ fontSize: 17, fontWeight: "600", color: "white" }}>
                    Place Order
                    </Text>
                </Pressable>
