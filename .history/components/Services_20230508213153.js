...
const Services = () => {
    return (
        <View style={{padding:10}}>
            ...
            <Swiper showsButtons={false} style={{height:250}}>
                {services.map((service,index) => (
                    <Pressable style={{margin:10,backgroundColor:"white",padding:20,borderRadius:7, justifyContent:'center', alignItems}} key={index}>
